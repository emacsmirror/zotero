      ...
      (when-let ((items (zotero-lib-plist-get* data :message :items))
        ...
        (pcase (plist-get item :type)
          ...
          ((or "book" "book" "book-series" "book-set" "book-track" "monograph" "reference-book")
           (setq result (zotero-cache-item-template "book"))
          ...
          ((or "book-chapter" "book-part" "book-section" "reference-entry")
           (setq result (zotero-cache-item-template "bookSection"))
          ...
          ((or "dataset" "posted-content" "report" "report-series" "standard")
           (setq result (zotero-cache-item-template "report"))
          ...
          ;; Conference paper
          ("proceedings-article"
           (setq result (zotero-cache-item-template "conferencePaper"))
          ...
          ;; Thesis
          ("dissertation"
           (setq result (zotero-cache-item-template "thesis"))
