...
**** Example
     ...
     calling src_emacs-lisp{zotero-response-status-code response},
     src_emacs-lisp{zotero-response-headers response},
     src_emacs-lisp{zotero-response-version response},
     src_emacs-lisp{zotero-response-etag response}, and
     src_emacs-lisp{zotero-response-data response}. For example:
